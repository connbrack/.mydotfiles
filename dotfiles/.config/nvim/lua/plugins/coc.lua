-- from https://gist.github.com/dinhmai74/4fc774dfd69750ce9ed706620a5082a9
local M = {
  "neoclide/coc.nvim",
  branch = "master",
...
vim.cmd("let g:coc_global_extensions = [ 'coc-sh', 'coc-pyright', 'coc-tsserver', 'coc-emmet', 'coc-svelte', 'coc-eslint', 'coc-json', 'coc-prettier', 'coc-css', 'coc-git', 'coc-lua', 'coc-rls', 'coc-spell-checker' ]")
